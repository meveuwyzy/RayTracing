...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/17 03:22:30 by dalonso           #+#    #+#             */
/*   Updated: 2020/11/17 03:22:33 by dalonso          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		parse_orient(const char *line, t_vec *orient)
{
	...
	if (orient->z > 1.0 || orient->z < -1.0)
		raise_exception("Error while reading one of orientation vector", 46);
	if (orient->x == 0.0 && orient->y == 0.0 && orient->z == 0.0)
		raise_exception("Zero orientation vector", 24);
	return (i);
}
